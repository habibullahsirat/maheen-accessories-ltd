...
import { usePortfolioData } from "@/lib/DataFetch/SWRDataFetch";
import PortfolioForm from "./PortfolioForm";
import Modal from "@/components/ui/Modal";
import { toast } from "sonner";

export default function PortfolioManager() {
  const { data: photo, mutate, isLoading } = usePortfolioData();
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingPortfolio
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/portfolio/${editingPortfolio._id}`
  ...
  return (
    <div className="">
      ...
      <Modal
        ...
        title={editingPortfolio ? "Edit Photo" : "Add New Photo"}
      >
        <PortfolioForm
