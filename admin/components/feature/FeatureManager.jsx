...
import { useFeatureData } from "@/lib/DataFetch/SWRDataFetch";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/feature/${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const url = editingFeature
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/feature/${editingFeature._id}`
